            ...
            <div style={{ width: '100%' }} id='top'>
                ...
                <div style={{ minHeight: '100vh', height: '200vh' }}>
                    <div className={homeStyles.homeBackDiv}>
                        ...
                        <img src={'images/doctor_home_bg.png'} width={"50%"} style={{position: 'absolute', right: 0, top: '110px'}} />
                    </div>
                    ...
                    <center>
                            <h2><span style={{ fontFamily: 'Papyrus', display:'block', marginTop:'25px', color:"#f5427e" }}>...Welcome Back Doctor...</span>A safe and secure place to keep<br />your appointment information and<br /> prescriptions data, available to you and<br /> your patients anytime,<br />including in an emergency<br /></h2>
                    </center>
                    </Col>
                        <Card style={{position:'absolute', top: '450px', marginLeft:'6.5%', width:'500px', background:'#e3f2ff'}}>
                            <CardContent style={{display:'flex', padding:'16px'}}>
                                <Row style={{width:'100%'}}>
                                    <Col style={{textAlign:'center', color:'#042f80'}}>
                                        <h1><CountUp duration={1} className="counter" end={channelingcount} /></h1>
                                        Channeling
                                    </Col>
                                    <Col style={{textAlign:'center', color:'#ed773b'}}>
                                        <h1><CountUp duration={1} className="counter" end={totalpatientcount} /></h1>
                                        Total Patients
                                    </Col>
                                </Row>
                            </CardContent>
